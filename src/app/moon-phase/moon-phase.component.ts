...
export class MoonPhaseComponent implements OnInit {
  ...
  getMoonImage(mooonFraction: number){
    ...
    if (mooonFraction > 21 / 28 && mooonFraction < 22 / 28) {
      ...
      icon.link = 'wi wi-moon-third-quarter';
      return icon;
      }
